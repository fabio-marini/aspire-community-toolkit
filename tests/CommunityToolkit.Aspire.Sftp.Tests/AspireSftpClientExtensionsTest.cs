...
public class AspireSftpClientExtensionsTest
{
    ...
    public void CanAddMultipleKeyedServices()
    {
        ...
        builder.Configuration.AddInMemoryCollection([
            ...
            new KeyValuePair<string, string?>("Aspire:Sftp:Client:sftp1:Username", "user1"),
            new KeyValuePair<string, string?>("Aspire:Sftp:Client:sftp1:Password", "pass1"),
            new KeyValuePair<string, string?>("Aspire:Sftp:Client:sftp1:DisableHealthChecks", "true"),
            new KeyValuePair<string, string?>("Aspire:Sftp:Client:sftp1:DisableTracing", "true"),
